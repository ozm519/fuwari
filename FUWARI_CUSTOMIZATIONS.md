...
| **背景图设置** | `src/config.ts` | `siteConfig.background.src` (约第 39 行)。|
...
export const antiLeechConfig: AntiLeechConfig = {
    enable: true,
    officialSites: [{ url: "https://ozm519.de5.net", name: "主站" }],  // ← 修改此处
    // ...
};
```

将 `ozm519.de5.net` 替换为您自己的域名。
...
| 位置 | 代码特征 | 当前值 |
|-----|---------|-------|
| 约第 364 行 | `v:['d3d3Lm1pY29zdGFyLmNj']` | `ozm519.de5.net` 的 Base64 编码 |
...
| 域名 | Base64 编码 |
|-----|------------|
| `ozm519.de5.net` | `d3d3Lm1pY29zdGFyLmNj` |
